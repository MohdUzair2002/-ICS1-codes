        ...
        if name=="umer".lower():
            ...
            if name=="admin":
                ...
                if name!="admin":
                    ...
                    p==True
passfile1=open ("C:/Users/Mohammad Uzair/Desktop/2.txt",'r')
pss2=passfile1.readlines()
leng3=len (pss2)
to1=0
uslis=[]
psli=[]
while (to1<leng3):
            ...
            splitt=ind1.split(',')
            username3=splitt[0]
            uslis.append (username3)
            password3=splitt[1]
            psli.append (password3)
            to1+=1
if (main=='u'):
    ...
    while (to<leng):
        ...
        if (username==usn and password==pasd):
          ...
          chgpas=input ("Do you want to Change your User name or Password")
          if (chgpas=='y'):
           spec6=input ("What will you like to change")
          if (spec6=='u'):
            newpas=input ("Type your New Username" )
            uslis.remove(uslis[to])
            uslis.insert (to,newpas)
            print (uslis)
...
if main!='a' or main !='u':
    print ("type a for admin and u for user ")
else:
