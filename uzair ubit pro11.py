    ...
    if (i==0):
       if (us==a and ps==b and ad==p ):
            ...
            while (k<ff):
                za=y[k]
                zz=za.split (',')
                print (f"The S.no. of the resident in the program is {zz[0]}-,has name {zz[1]},lives in flat no:- {zz[2]},has no of cars ={zz[3]},has no of bikes {zz[4]},has house maintenance={int  (zz[5]*5)}  ")
                k+=1
    t=y[i]
    o=t.split (',')
    v=o[0]
